// ts2fable 0.9.0
module rec Fable.CosmJS.TendermintRpc.Tendermint34.Tendermint34Client
...
type [<AllowNullLiteral>] IExports =
    abstract Tendermint34Client: Tendermint34ClientStatic

type [<AllowNullLiteral>] Tendermint34Client =
...
type [<AllowNullLiteral>] Tendermint34ClientStatic =
    /// Creates a new Tendermint client for the given endpoint.
    /// 
    /// Uses HTTP when the URL schema is http or https. Uses WebSockets otherwise.
    abstract connect: endpoint: U2<string, HttpEndpoint> -> Promise<Tendermint34Client>
    /// Creates a new Tendermint client given an RPC client.
    abstract create: rpcClient: RpcClient -> Promise<Tendermint34Client>