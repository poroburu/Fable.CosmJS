// ts2fable 0.9.0
module rec Fable.CosmJS.TendermintRpc.Tendermint34.Encodings
...
type BlockId = Fable.CosmJS.TendermintRpc.Tendermint34.Responses.BlockId
type Version = Fable.CosmJS.TendermintRpc.Tendermint34.Responses.Version
